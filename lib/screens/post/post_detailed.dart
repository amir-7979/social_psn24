...
class PostDetailed extends StatefulWidget {
  final Post post = Post(id: '1', name: 'name', description: 'description', creator: Creator(name: 'name', family: 'family', username: 'username', displayName: 'displayName'), persianDate: '1399/01/01', viewCount: 0, voteUp: false, voteDown: false, currentUserUpVotes: false, currentUserDownVotes: false, currentUserLiked: false, currentUserNotificationEnabled: false, isLiked: false, isNotificationEnabled: false, medias: []);
  PostDetailed({super.key});
