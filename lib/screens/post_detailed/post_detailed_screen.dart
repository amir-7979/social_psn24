...
import 'widget/post_detailed_badges.dart';
...
class _PostDetailedScreenState extends State<PostDetailedScreen> {
  ...
  void _fetchComments(int pageKey) {
    PostDetailedBloc.fetchComments(
        pagingController, widget.post.id ?? '', 10, null);
  }
      ...
      child: Container(
        ...
        child: BlocProvider(
          create: (context) => PostDetailedBloc()
            ..add(IncreasePostViewEvent(
                postId: widget.post.id, viewCount: widget.post.viewCount)),
            ...
            return BlocListener<PostDetailedBloc, PostDetailedState>(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  SizedBox(height: 24),
                  PostDetailedBadges(widget.post, isUserLoggedIn),
                  SizedBox(height: 8),
                  CommentList(
