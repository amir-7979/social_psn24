...
class _PostDetailedBadgesState extends State<PostDetailedBadges> {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        ...
        BlocProvider.of<SettingBloc>(context).state.userSettings.showLikeCountPostScreen ? buildBadgeIcons(context, badgePosition) : buildIcons(context, badgePosition),
      ],
    );
  }

  Row buildBadgeIcons(BuildContext context, badges.BadgePosition badgePosition) {
    return Row(
  ...
  Row buildIcons(BuildContext context, badges.BadgePosition badgePosition) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.center,
      crossAxisAlignment: CrossAxisAlignment.center,
      children: [
